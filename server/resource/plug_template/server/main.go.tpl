...
import (
	gvaGlobal "github.com/pauljohn21/cms-gva/server/global"
	"github.com/pauljohn21/cms-gva/server/model/system"
	"github.com/pauljohn21/cms-gva/server/plugin/plugin-tool/utils"
{{- if .HasGlobal }}
	"github.com/pauljohn21/cms-gva/server/plugin/{{ .Snake}}/global"
{{- end }}
	"github.com/pauljohn21/cms-gva/server/plugin/{{ .Snake}}/router"
