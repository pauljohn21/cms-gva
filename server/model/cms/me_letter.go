...
type MeLetter struct {
	...
	Coverage       string `json:"coverage" form:"coverage" gorm:"column:coverage;comment:含税总保费;size:191;" binding:"required"`
	CoverageNzh    string `json:"coveragenzh" form:"coveragenzh"`
	CoverageAllNzh string `json:"coverageAllnzh" form:"coverageAllnzh"` // 含税总保费
	// 含税总保费
